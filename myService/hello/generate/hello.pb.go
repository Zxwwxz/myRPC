...
func (m *ByeResponse) GetReply() string {
	if m != nil {
		return m.Reply
	}
	return ""
...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "pbHello.HelloRequest")
	proto.RegisterType((*HelloResponse)(nil), "pbHello.HelloResponse")
	proto.RegisterType((*ByeRequest)(nil), "pbHello.ByeRequest")
	proto.RegisterType((*ByeResponse)(nil), "pbHello.ByeResponse")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	,
}
...
func (c *helloServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pbHello.HelloService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) SayBye(ctx context.Context, in *ByeRequest, opts ...grpc.CallOption) (*ByeResponse, error) {
	out := new(ByeResponse)
	err := c.cc.Invoke(ctx, "/pbHello.HelloService/SayBye", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHelloServiceServer) SayBye(ctx context.Context, req *ByeRequest) (*ByeResponse, error) {
...
func _HelloService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pbHello.HelloService/SayHello",
	}
...
func _HelloService_SayBye_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pbHello.HelloService/SayBye",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _HelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pbHello.HelloService",
